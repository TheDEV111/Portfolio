...
export const projects: Project[] = [
  {
    ...
    longDescription: "STXWorx is a decentralised freelance marketplace built on the Stacks blockchain (Bitcoin Layer 2). Clients post jobs and fund them into on-chain escrow using STX tokens. Payments are released in milestones as work is verified, and disputes are settled through an admin moderation layer — eliminating payment risk for both parties. The platform supports multiple job categories, wallet-based authentication via Stacks Connect, an Ambassador programme for top contributors, and a real-time chat and notification system.",
    tech: ["React", "TypeScript", "Clarity", "Stacks Blockchain", "Stacks Connect", "Node.js", "Tailwind CSS"],
    github: "",
    githubPrivate: true,
    live: "https://www.stxworx.com/",
    image: "/stxworx.png",
    icon: Blocks,
    category: "Blockchain",
    featured: true,
    features: [
      "On-chain escrow for project funding with STX tokens",
      "Milestone-based payment release on Stacks (Bitcoin L2)",
      "Admin-moderated dispute resolution",
      "Wallet authentication via Stacks Connect",
      "Job categories: Dev, Design, Marketing, Media & Content",
      "Ambassador programme for top-rated freelancers",
      "Real-time chat and notification system",
      "Featured jobs feed and freelancer profiles"
    ],
    challenges: "Designing a milestone escrow contract in Clarity that handles partial releases, refund windows, and dispute escalation without custodial risk. Building a real-time job feed and chat layer on top of a Stacks-native auth model while keeping the UX frictionless for non-crypto users.",
    outcome: "Live at stxworx.com — a fully functional freelance marketplace on Stacks with on-chain escrow, milestone payments, and an active community of freelancers and clients."
  },
  {
    title: "sBTC Pulse",
    description: "Personal sBTC analytics dashboard — track health score, rewards, collateral ratio, and lock duration on Stacks",
    longDescription: "sBTC Pulse is a real-time analytics dashboard for sBTC holders on the Stacks blockchain. It gives users a clear, live view of their sBTC position through a composite Health Score (0–100) weighted across three factors: Collateral Ratio (40%), Reward Efficiency (40%), and Lock Duration (20%). The dashboard surfaces balance changes, rewards earned in BTC and USD, epoch countdowns, a recent activity feed, and a global leaderboard — helping users optimise their sBTC strategy at a glance.",
    tech: ["React", "TypeScript", "Stacks Blockchain", "sBTC", "Stacks Connect", "Tailwind CSS"],
    github: "",
    githubPrivate: true,
    live: "https://sbtc-pulse-app.vercel.app/",
    image: "/sbtc-pulse.png",
    icon: Radio,
    category: "Blockchain",
    featured: true,
    features: [
      "Composite Health Score (0–100) across Collateral, Rewards, and Lock Duration",
      "Live sBTC balance with 24h delta tracking",
      "Rewards earned displayed in BTC and USD",
      "Epoch countdown and lock duration visualisation",
      "Score breakdown: Collateral 34pts, Rewards 37pts, Lock 15pts",
      "Recent activity feed (epoch rewards, lock extensions, peg-ins)",
      "Global leaderboard for sBTC holders",
      "Epoch notifications and recommendations",
      "Dark / light mode toggle",
      "Wallet auth via Stacks Connect"
    ],
    challenges: "Designing a meaningful health score model that accurately reflects sBTC position quality across three independent axes without over-indexing on any single factor. Keeping the dashboard reactive to epoch changes in real time while avoiding excessive RPC calls that could degrade performance.",
    outcome: "Live at sbtc-pulse-app.vercel.app — a fully functional sBTC analytics dashboard giving Stacks users actionable insight into their position health, rewards, and locking strategy."
  },
  {
    title: "Pop-Predict",
    description: "Decentralised prediction market for staking STX tokens on pop-culture outcomes — movies, awards, sports",
    longDescription: "Pop-Predict is a fully on-chain parimutuel prediction market built on Stacks (Bitcoin Layer 2). Users stake STX tokens on binary or multi-outcome markets tied to real-world pop-culture events. Outcomes are resolved by a decentralised oracle network, and winners receive proportional payouts. The platform also mints soulbound achievement NFTs for active participants, creating a reputation layer on top of the prediction mechanics.",
    tech: ["Next.js 15", "TypeScript", "Clarity 4", "Stacks Blockchain", "Leather Wallet", "Hiro Wallet", "Tailwind CSS"],
    github: "https://github.com/TheDEV111/Pop-predict",
    live: "",
    ...
    featured: true,
    features: [
      "Parimutuel betting with STX tokens on Stacks (Bitcoin Layer 2)",
      "Binary and multi-outcome market types",
      "Oracle-based market resolution",
      "Soulbound achievement NFTs for participants",
      "Leather and Hiro Wallet integration",
      "Testnet deployed — Phase 2 in progress"
    ],
    challenges: "Implementing a fair parimutuel payout model in Clarity smart contracts while handling edge cases like single-winner markets and oracle disputes. Designing a soulbound NFT system that can't be transferred but still reflects verifiable on-chain activity.",
    outcome: "Testnet-deployed prediction market with parimutuel mechanics and soulbound NFTs running on Stacks. Phase 2 development ongoing."
  },
  {
    title: "MarketX",
    description: "Secure decentralised P2P marketplace and escrow platform on the Stellar Network",
    longDescription: "MarketX is a peer-to-peer marketplace secured by Soroban smart contracts on Stellar. Escrow funds are locked on-chain and only released when both buyer and seller confirm transaction completion, eliminating the need for a trusted third party. The platform features hybrid authentication (JWT + Web3 wallet), role-based workflows for buyers and sellers, and a dark-mode UI with glassmorphism design.",
    tech: ["Next.js 15", "React 19", "TypeScript", "Soroban (Rust)", "Stellar Network", "Freighter Wallet", "TanStack Query", "Tailwind CSS v4"],
    github: "https://github.com/TheDEV111/MarketX-frontend",
    live: "",
    image: "/marketx.png",
    icon: Shield,
    category: "Open Source",
    ...
    featured: true,
    features: [
      "On-chain escrow via Soroban smart contracts",
      "Hybrid auth — JWT sessions + Freighter wallet",
      "Role-based buyer and seller workflows",
      "Dispute resolution system",
      "Real-time transaction status tracking",
      "Glassmorphism dark-mode UI"
    ],
    challenges: "Designing an escrow contract that handles dispute windows, partial refunds, and multi-asset support on Stellar without custodial risk. Combining traditional JWT auth with wallet-based identity in a single seamless session.",
    outcome: "Fully functional P2P marketplace with Soroban escrow on Stellar testnet. MIT licensed and actively developed."
  },
  {
    title: "Nova-Launch",
    description: "No-code token deployment platform for the Stellar blockchain — launch custom tokens in minutes",
    longDescription: "Nova-Launch lets anyone deploy a custom token on Stellar without writing a single line of Soroban smart contract code. Users configure token name, supply, admin controls, burn mechanisms, and IPFS metadata through a guided UI. The platform handles contract compilation, deployment, and wallet signing via Freighter. Base deployment costs 7 XLM, metadata storage adds 3 XLM. Built mobile-first with PWA support and 80%+ test coverage.",
    tech: ["React 19", "TypeScript 5.9", "Vite", "Soroban (Rust)", "Stellar Network", "Freighter Wallet", "IPFS / Pinata", "Tailwind CSS 4.1", "Vitest"],
    github: "https://github.com/TheDEV111/Nova-Launch",
    live: "",
    ...
    featured: true,
    features: [
      "No-code Soroban token deployment on Stellar",
      "Admin-controlled minting and burn mechanisms",
      "IPFS metadata storage via Pinata",
      "Freighter wallet signing flow",
      "Mobile-first PWA with offline support",
      "27+ passing tests, 80%+ code coverage",
      "Upcoming: analytics dashboard, batch deployment, token marketplace"
    ],
    challenges: "Abstracting Soroban contract compilation and deployment into a reliable no-code flow with clear user feedback. Handling IPFS upload failures gracefully and ensuring metadata permanence without centralised storage.",
    outcome: "MVP shipped with 27+ passing tests. Token deployment live on Stellar testnet. Analytics and marketplace features in roadmap."
  },
  {
    title: "Alien-Gateway",
    description: "Zero-knowledge username system for Stellar — send crypto via @username with full wallet privacy",
    longDescription: "Alien-Gateway is a privacy-preserving payment routing system for the Stellar blockchain. Users register a @username that maps to their wallet address using zero-knowledge commitments (Groth16 / Poseidon hash), so the on-chain link between username and address is cryptographically hidden. Senders resolve a @username to route payments without ever exposing the recipient's real wallet. Built with Rust Soroban contracts, Circom ZK circuits, and a TypeScript SDK.",
    tech: ["Rust (Soroban)", "Circom", "Groth16", "Poseidon Hash", "TypeScript SDK", "Stellar Network"],
    github: "https://github.com/TheDEV111/Alien-Gateway",
    live: "",
    ...
    featured: true,
    features: [
      "Send Stellar payments via @username — no raw address needed",
      "Zero-knowledge wallet-to-username commitments (Groth16)",
      "Poseidon hash for ZK-friendly on-chain commitments",
      "Circom circuits for proof generation",
      "TypeScript SDK for wallet and dApp integration",
      "Privacy-preserving payment routing on Stellar mainnet"
    ],
    challenges: "Implementing Groth16 proof verification inside a Soroban smart contract within Stellar's compute budget constraints. Designing a username commitment scheme that hides wallet identity while still allowing payment routing without leaking metadata.",
    outcome: "178 commits — production-ready ZK username system on Stellar with Circom circuits, Soroban contracts, and a TypeScript SDK."
  },
  {
    title: "SoroTask",
    description: "Decentralised automation marketplace solving smart contracts' 'only run when called' limitation",
    longDescription: "SoroTask is a keeper-network marketplace on Stellar where developers register recurring on-chain tasks (e.g. auto-compound yield, liquidate undercollateralised positions, settle escrows) and keepers compete to execute them for incentive rewards. Built with Next.js frontend, NestJS backend, and Soroban/WebAssembly contracts. Docker-deployed with health monitoring and metrics tracking.",
    tech: ["Next.js", "TypeScript", "NestJS", "Rust (Soroban / WebAssembly)", "Node.js", "Docker", "Stellar Network"],
    github: "https://github.com/TheDEV111/SoroTask",
    live: "",
    image: "/sorotask.png",
    icon: Cpu,
    category: "Open Source",
    ...
    featured: true,
    features: [
      "Keeper-network incentive system for on-chain task execution",
      "Recurring task registration and scheduling",
      "Soroban / WebAssembly contract execution",
      "Health monitoring and metrics dashboard",
      "Docker-based deployment with multi-service architecture",
      "Supports DeFi automation: liquidations, yield compounding, escrow settlement"
    ],
    challenges: "Designing a trustless keeper incentive model where keepers are rewarded fairly but cannot grief tasks or front-run sensitive operations. Building a WASM-based execution environment inside Soroban's deterministic compute model.",
    outcome: "Functional decentralised automation marketplace on Stellar with keeper incentives, WASM execution, and Docker deployment."
  },
  {
    title: "Hintents",
    description: "Glass-box debugging toolset for Stellar Soroban smart contracts — transaction replay, flamegraphs, and audit logs",
    longDescription: "Hintents is a premium developer toolset for debugging, profiling, and auditing Soroban smart contracts on Stellar. It replays historical transactions in a sandboxed soroban-env-host, generates interactive trace viewers and performance flamegraphs, source-maps WASM bytecode back to Rust source lines, and produces tamper-proof audit logs signed with Ed25519 / HSM keys. Designed for teams that need full transparency into on-chain execution.",
    tech: ["Go", "Rust", "TypeScript", "Stellar RPC", "Soroban", "WASM", "Docker", "Jest", "Cargo"],
    github: "https://github.com/TheDEV111/hintents",
    live: "",
    image: "/hintents.png",
    icon: Code2,
    category: "Open Source",
    ...
    featured: false,
    features: [
      "Transaction replay in sandboxed soroban-env-host",
      "Interactive trace viewer for contract execution paths",
      "Performance flamegraphs for bottleneck identification",
      "WASM-to-Rust source mapping",
      "Ed25519 / HSM-signed tamper-proof audit logs",
      "Custom erst:// URI protocol for trace navigation",
      "80%+ code coverage, strict quality standards"
    ],
    challenges: "Replaying Stellar transactions deterministically outside the live network while keeping the environment faithful to mainnet semantics. Building WASM-to-Rust source mapping without losing line accuracy across compiler optimisation passes.",
    outcome: "1,671 commits — Phase 4 (Advanced Diagnostics) complete. Production-grade debugging toolset adopted for Soroban contract development and auditing."
  },
  {
    title: "MetaFlux",
